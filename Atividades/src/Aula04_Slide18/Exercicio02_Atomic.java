...
public class Exercicio02_Atomic extends Thread {

    ListaCompartilhada_Atomic lista;

    public Exercicio02_Atomic(ListaCompartilhada_Atomic l, ThreadGroup tg, String t1) {
        super(tg, t1);
        this.lista = l;
    }
